const devices: Array<{ name: string; type: string; size: { width: number; height: number } }> = [
	// Mobiles
	{
		name: 'iPhone 8',
		type: 'mobile',
...
export const desktopDevices = [...desktopFilter];
export const mobileDevices = [...mobileFilter, ...tabletFilter];
